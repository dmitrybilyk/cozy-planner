...
class LinkDatabaseHelper(context: Context) : SQLiteOpenHelper(context, "linkease.db", null, 10) {
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        ...
        if (oldVersion < 7) {
            db.execSQL("ALTER TABLE clients ADD COLUMN packageTotal INTEGER NOT NULL DEFAULT 0")
            db.execSQL("ALTER TABLE clients ADD COLUMN packageUsed INTEGER NOT NULL DEFAULT 0")
        ...
        if (oldVersion < 10) {
            db.execSQL("ALTER TABLE sessions ADD COLUMN paid INTEGER NOT NULL DEFAULT 0")
        }
    }
}
