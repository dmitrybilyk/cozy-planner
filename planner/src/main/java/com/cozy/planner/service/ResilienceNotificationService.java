...
public class ResilienceNotificationService implements NotificationService {
    ...
    public Mono<Boolean> sendFridayReminder(Trainee trainee, String baseUrl) {
        return route(kafka.sendFridayReminder(trainee, baseUrl), telegram.sendFridayReminder(trainee, baseUrl));
    }
    ...
    public Mono<Boolean> sendMentorTraineeAvailabilityUpdateNotification(Mentor mentor, Trainee trainee) {
        return route(
                kafka.sendMentorTraineeAvailabilityUpdateNotification(mentor, trainee),
                telegram.sendMentorTraineeAvailabilityUpdateNotification(mentor, trainee)
        );
    }
