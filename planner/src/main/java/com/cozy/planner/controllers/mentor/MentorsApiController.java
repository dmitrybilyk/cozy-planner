...
public class MentorsApiController implements MentorsApi {
    ...
    private final com.cozy.planner.service.notification.TelegramService telegramService;
    private final EventBroadcastService eventBroadcastService;

    public MentorsApiController(MentorRepository mentorRepository,
                                  TraineeRepository traineeRepository,
                                  TelegramConfig telegramConfig,
                                  com.cozy.planner.service.notification.TelegramService telegramService,
